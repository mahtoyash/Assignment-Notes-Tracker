...
# Telephony Provider & Exotel India Config
TELEPHONY_PROVIDER = os.getenv("TELEPHONY_PROVIDER", "exotel").lower()

# Exotel India Telephony Config
...
def is_exotel_enabled() -> bool:
    ...
    return bool(EXOTEL_ACCOUNT_SID and EXOTEL_API_KEY and EXOTEL_API_TOKEN and EXOTEL_CALLER_ID)
